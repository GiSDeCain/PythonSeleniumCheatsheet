"""Selenium 4 waits: WebDriverWait and expected_conditions."""
...
def test_can_wait_until_element_is_visible(driver):
    ...
    text_input = page.wait.until(EC.visibility_of_element_located(TEXT_INPUT))
...
def test_can_wait_until_element_is_clickable(driver):
    ...
    submit_button = page.wait_until_clickable(SUBMIT_BUTTON)
